...
from .types.list_flows_response_item import ListFlowsResponseItem
...
class AssetsClient:
    ...
    def import_rule(self, *, rule: typing.Dict[str, typing.Any]) -> typing.Dict[str, typing.Any]:
        """
        Import a rule into the user's account.

        Parameters:
            - rule: typing.Dict[str, typing.Any]. The rule data to import.
        ---
        from rulebricks.client import RulebricksApi
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json=jsonable_encoder({"rule": rule}),
            headers=self._client_wrapper.get_headers(),
            timeout=60,
        )
        if 200 <= _response.status_code < 300:
    ...
    def list_flows(self) -> typing.List[ListFlowsResponseItem]:
        """
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(typing.List[ListFlowsResponseItem], _response.json())  # type: ignore
        if _response.status_code == 500:
            raise InternalServerError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
        try:
            _response_json = _response.json()
...
class AsyncAssetsClient:
    ...
    async def import_rule(self, *, rule: typing.Dict[str, typing.Any]) -> typing.Dict[str, typing.Any]:
        """
        Import a rule into the user's account.
    ...
    async def list_flows(self) -> typing.List[ListFlowsResponseItem]:
        """
        List all flows in the organization.
